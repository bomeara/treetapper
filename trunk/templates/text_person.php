...
if ($hascollaboratorid) {
	...
	foreach ($collaboratorarray as $key => $val) {
		...
		echo "$personid\t$personfirst\t$personmiddle\t$personlast\t$personurl\t$personrefcount\t$personmethodcount\t$personprogramcount\t$val\n";
	...
	//person id, first, middle, last, url, refcount, method count, program count;
		echo "$personid\t$personfirst\t$personmiddle\t$personlast\t$personurl\t$personrefcount\t$personmethodcount\t$personprogramcount\n";
	}
}
?>
